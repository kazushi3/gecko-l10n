...
places-maintenance-button =
    .label = @@ImportNoun@@とバックアップ
    .tooltiptext = ブックマークの@@ImportNoun@@とバックアップができます
    .accesskey = I
...
places-import-bookmarks-from-html =
    .label = HTML から@@Import@@...
    .accesskey = I
places-export-bookmarks-to-html =
    .label = HTML として@@Export@@...
    .accesskey = E
places-import-other-browser =
    .label = 他のブラウザーからデータを@@Import@@...
    .accesskey = A
