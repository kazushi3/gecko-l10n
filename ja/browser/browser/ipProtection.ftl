...
ipprotection-feature-introduction-link-text-captive-portal-1 = いくつかの場所から選んで現在位置を隠して <a data-l10n-name="learn-more-vpn">プライバシーを強化</a> しましょう。
...
ipprotection-location-selection-callout-description-1 = <a data-l10n-name="learn-more-vpn">{ -brand-product-name } の組み込み VPN</a> は、いくつかの選択肢からブラウジング場所を選ぶか、接続速度が最も速い場所を代わりにピックアップして利用します。
...
ipprotection-connection-status-connected-1 = VPN オン
    .aria-label = VPN オン
ipprotection-connection-status-disconnected-1 = VPN オフ
    .aria-label = VPN オフ
ipprotection-connection-status-excluded-1 = このサイトでは VPN オフ
    .aria-label = このサイトでは VPN オフ
ipprotection-connection-status-connecting-1 = VPN に接続しています...
    .aria-label = VPN に接続しています...
...
ipprotection-connection-status-paused-title-2 = VPN は停止しています
    .aria-label = VPN は停止しています
...
ipprotection-connection-status-network-error-title-1 = インターネット接続を確認してください
    .aria-label = インターネット接続を確認してください
...
ip-protection-not-opted-in-4 =
    ...
    .message = 現在位置を隠してブラウジングのプライバシー保護を強化しましょう。
