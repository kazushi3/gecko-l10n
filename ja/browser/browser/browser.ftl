...
reduced-protection-infobar-message = <strong>Site looks broken?</strong> Reload the page to temporarily lower your tracking protection.(^^k
reduced-protection-infobar-reload-button = Reload(^^k
    .accesskey = R
reduced-protection-infobar-never-show-button = Don’t show again(^^k
    .accesskey = D
