...
customkeys-clear = 消去
customkeys-new-key = @@New-CMD@@キーを入力:
...
customkeys-nav-select-tab-1 = タブ 1 を開く
customkeys-nav-select-tab-2 = タブ 2 を開く
customkeys-nav-select-tab-3 = タブ 3 を開く
customkeys-nav-select-tab-4 = タブ 4 を開く
customkeys-nav-select-tab-5 = タブ 5 を開く
customkeys-nav-select-tab-6 = タブ 6 を開く
customkeys-nav-select-tab-7 = タブ 7 を開く
customkeys-nav-select-tab-8 = タブ 8 を開く
customkeys-nav-select-last-tab = 最後のタブを開く
