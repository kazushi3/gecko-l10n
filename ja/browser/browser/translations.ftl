...
translations-panel-error-unsupported-hint-known-2 = Sorry, we don’t support translations from { $language } yet.(^^k
translations-panel-error-unsupported-hint-unknown-2 = Sorry, we don’t support translations from this language yet.(^^k
# If your language requires declining the language name, a possible solution
# is to adapt the structure of the phrase, or use a support noun, e.g.
...
select-translations-panel-unsupported-language-message-known-2 =
    .message = Sorry, we don’t support translations from { $language } yet.(^^k
select-translations-panel-unsupported-language-message-unknown-2 =
    .message = Sorry, we don’t support translations from this language yet.(^^k
# If your language requires declining the language name, a possible solution
# is to adapt the structure of the phrase, or use a support noun, e.g.
# `Sorry, we don't support the language yet: { $language }
#
