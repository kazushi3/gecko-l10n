...
existing-user-tou-message = <strong>ユーザーの皆様へ</strong> 私たちは { -brand-short-name } <a data-l10n-name="terms-of-use-link">利用規約</a> を導入し、<a data-l10n-name="privacy-notice-link">プライバシー通知</a> を更新しました。内容をお読みの上、ご承諾願います。
...
existing-user-privacy-notice-update-message = We’ve updated our <a data-l10n-name="privacy-notice-link">Privacy Notice</a> to reflect the latest features in { -brand-short-name }.(^^k
