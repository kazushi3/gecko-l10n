...
more-from-moz-firefox-mobile =
    .label = モバイル版 { -brand-product-name }
    .description = ユーザーのプライバシー第一のモバイルブラウザーです。
...
more-from-moz-thunderbird-description = 無料のメール、カレンダー、アドレス帳 — 自分のやり方で整理できます。
more-from-moz-thunderbird-button = { -thunderbird-brand-short-name } を入手

## These strings are for the Mozilla New Products card in about:preferences moreFromMozilla page

more-from-moz-new-products-title = { -vendor-short-name } の新製品
more-from-moz-new-products-description = { -vendor-short-name } から最新の製品をお届けします。
more-from-moz-new-products-button = 新製品を見る
...
more-from-moz-firefox-mobile-qr-promo =
    .message = スマートフォンやタブレットのカメラでスキャンしてアプリを入手。表示されたらリンクをタップ。
more-from-moz-firefox-mobile-email-link = ダウンロードリンクをスマートフォンにメール送信する
...
more-from-moz-mozilla-monitor-card =
    ...
    .description = あなたの個人情報がオンラインで漏洩していないか無料のスキャンで見つけ出します。
more-from-moz-mozilla-vpn-card =
    .label = { -mozilla-vpn-brand-name }
    .description = ブラウザーだけでなく、すべてのアプリに防護を追加します。公衆 Wi-Fi や安全でないネットワークでユーザーデータの安全を守ります。
more-from-moz-firefox-relay-card =
    .label = { -relay-brand-name }
    .description = 無料のメールマスクで受信トレイをスパムから保護します。
more-from-moz-mdn-card =
    .label = { -mdn-brand-name }
    .description = 無料のガイドとリファレンスでウェブ開発を学びます。
...
more-from-moz-solo-card-1 =
    ...
    .description = Create your website instantly and connect your own custom domain for free.(^^k
more-from-moz-new-products-card2 =
    .label = { -vendor-short-name } New Products
    .description = Explore our latest ideas and experimental technologies.(^^k
more-from-moz-mozilla-monitor-box-link =
    .label = { -monitor-brand-short-name } を利用する
more-from-moz-mozilla-vpn-box-link =
    .label = { -mozilla-vpn-brand-name } を入手する
more-from-moz-firefox-relay-box-link =
    .label = { -relay-brand-short-name } を入手する
more-from-moz-mdn-box-link =
    .label = MDN にアクセスする
more-from-moz-thunderbird-box-link =
    .label = { -thunderbird-brand-short-name } を入手する
more-from-moz-solo-box-link =
    .label = { -solo-ai-brand-name } を試す
