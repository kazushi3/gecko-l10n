...
settings-tabs-drag-to-create-tab-groups =
    .label = Drag tabs together to create tab groups(^^k
...
account-placeholder2 =
    .label = You’re not signed in(^^k
    .description = Sign in and keep your data private, encrypted, and instantly accessible everywhere you use { -brand-short-name }.(^^k
account-group-label =
...
sync-syncing-across-devices-empty-state2 =
    .label = Manage synced data(^^k
    .description = You aren’t syncing anything… yet. Start syncing to get all of your data on all your devices.(^^k
...
history-remember-option-never2 =
    .label = 履歴を一切記憶させない
    .description = すべての@@Window@@がプライベート@@Window@@のようになります。オンにした場合は必要な拡張機能を許可してください。
...
permissions-block-popups-exceptions-button4 =
    ...
    .description = Add websites that can open pop-ups and use third-party redirects.(^^k
    .accesskey = E
    .searchkeywords = popups(^^k
...
nimbus-rollouts =
    .label = Allow { -brand-short-name } to improve features, performance, and stability between updates(^^k
    .description = Changes will be rolled out remotely.(^^k
...
data-collection-health-report-disabled =
    .label = Send technical and interaction data to { -vendor-short-name }(^^k
    .accesskey = r
    .description = Data reporting is disabled for this build configuration.(^^k
data-collection-run-studies =
    .label = Allow { -brand-short-name } to run feature studies(^^k
    .description = { -brand-short-name } randomly selects users to test features, which helps improve quality for everyone.(^^k
data-collection-studies-link =
    .label = { -brand-short-name } 調査を確認する
data-collection-backlogged-crash-reports =
    .label = Automatically send crash reports(^^k
    .description = This helps { -vendor-short-name } diagnose and fix issues with the browser. Reports may include personal or sensitive data.(^^k
    .accesskey = c
