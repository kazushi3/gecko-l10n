...
switch-to-new-tabs-2 =
    .label = @@NewTab@@でリンクやメディアを開いた時、すぐにそのタブに切り替える
    .accesskey = h
switch-to-new-tabs =
...
appearance-group2 =
    .label = ウェブサイトの外観
    .description = 一部のウェブサイトはユーザー設定に合わせて@@Colors@@を変更します。カラースキームを選んでください。
...
preferences-text-zoom-override-warning2 =
    .message = @@[@@文字サイズのみ変更@@]@@ がオンで@@Default-@@ズームが 100% でない場合、一部のサイトがコンテンツを正しく表示できない可能性があります。
...
download-private-browsing-delete2 =
    .label = プライベート@@Window@@を閉じるとき、ダウンロードしたファイルを削除する
    .accesskey = D
...
autofill-addresses-add-button = @@New-CMD@@住所を追加
