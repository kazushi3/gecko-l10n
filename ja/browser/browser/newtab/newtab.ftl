...
newtab-menu-section-unfollow-topic = Unfollow(^^k
# "Follow", "unfollow", and "following" are social media terms that refer to subscribing to or unsubscribing from a section of stories.
# e.g. Following the travel section of stories.
...
newtab-section-block-cancel-button = Cancel(^^k
...
newtab-section-toast-follow =
    .message = You’re now following { $topic }.(^^k
# Variables:
#   $topic (string) - Topic that the user has unfollowed
newtab-section-toast-unfollow =
    .message = You’re no longer following { $topic }.(^^k
# Variables:
#   $topic (string) - Topic that the user has blocked
newtab-section-toast-block =
    .message = You won’t see stories about { $topic } anymore.(^^k
...
newtab-widget-menu-change-size = Change size(^^k
newtab-widget-size-small = Small(^^k
newtab-widget-size-medium = Medium(^^k
newtab-widget-size-large = Large(^^k
...
newtab-promo-card-title-addons = Make { -brand-product-name } yours(^^k
newtab-promo-card-body-addons = Pick a wallpaper from our collection, or create your own.(^^k
newtab-promo-card-cta-addons = Try it now(^^k
