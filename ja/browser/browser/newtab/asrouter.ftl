...
welcome-back-spotlight-title = Leap back into built-in privacy(^^k
welcome-back-spotlight-subtitle = Welcome back to the only major browser backed by a non-profit. We take extra steps to protect your data wherever you roam.(^^k
welcome-back-embedded-import-title = Import your data and make { -brand-short-name } feel like home(^^k
