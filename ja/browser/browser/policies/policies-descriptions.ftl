...
policy-AIControls = Configure AI controls.(^^k
...
policy-IPProtectionAvailable = Prevent the built-in VPN from being available to users.(^^k
...
policy-RelaunchRequired = Require { -brand-short-name } to be relaunched within a given period and notify the user of the upcoming relaunch.(^^k
...
policy-SitePolicies = Site specific policies.(^^k
...
policy-XSLTEnabled = Enable or disable support for the XSLTProcessor JavaScript API and the XSLT processing instruction.(^^k
