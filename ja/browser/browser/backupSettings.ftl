...
restore-from-backup-type-add =
    .label = データを変更せず@@New-CMD@@プロファイルを作成する
...
backup-file-creation-metadata2 = <b>{ $profileName }</b> プロファイルを { $machineName } 上で { DATETIME($date, year: "numeric", month: "numeric", day: "numeric") } に作成(^^k
# Variables:
