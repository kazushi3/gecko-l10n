...
perftools-intro-description = 記録したデータは@@NewTab@@の profiler.firefox.com で開きます。データはすべてローカルに保存されますが、アップロードして共有することもできます。
...
perftools-button-capture-recording = 記録をキャプチャー
