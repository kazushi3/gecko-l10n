...
inactive-css-no-default-anchor = これは@@Default@@のアンカー要素を持たないため、<strong>{ $property }</strong> はこの要素に効果がありません。
...
css-selector-container-query-condition-no-container = No container ‘{ $name }’ found(^^k
